...
\includepdf[pages=-, landscape=true]{weightDecrease.pdf} \label{debugDecreaseAlgorithm}
\includepdf[pages=-, landscape=true]{weightIncrease.pdf} \label{debugIncreaseAlgorithm}
